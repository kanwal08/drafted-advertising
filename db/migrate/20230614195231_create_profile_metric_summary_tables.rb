class CreateProfileMetricSummaryTables < ActiveRecord::Migration[7.0]
  def change
    create_table :profile_product_targeting_metrics_summaries do |t|
    ...
    create_table :profile_keyword_metrics_summaries do |t|
      t.references :profile, foreign_key: true
      t.date :date
